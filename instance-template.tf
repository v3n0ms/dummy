...
sudo docker run -p 8080:8080 -d -e DB_USER=${local.envs[2]} -e DB_NAME=${local.envs[1]} -e DB_PASSWORD=${local.envs[3]} -e DB_HOST=${local.envs[0]} asia.gcr.io/dummy-project-365407/pos
EOF
